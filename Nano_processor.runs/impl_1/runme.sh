...
HD_PWD='C:/Users/ACER/Desktop/Done assingment/Nano_processor/Nano_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nano_Processor_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nano_Processor_0.tcl -notrace
